...
export const INTELLIGENT_ADAPTATION_INFO = {
  ...
  removalOrder: [
    ...
    '2. Mobilidade (removível primeiro)',
    '3. Técnica (removível cedo)',
    '4. Core/Acessório (suporte)',
    '5. Aquecimento (removível)',
    '6. Força (prioridade média)',
    '7. Específico HYROX (remove por último)',
    '8. Metcon (remove por último)',
    '9. Corrida (NUNCA remove, só reduz duração)',
  ],
  phases: [
